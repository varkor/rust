...
declare_features! (
    ...
    (lib, alloc_internals, None, None, None),
    (lib, alloc_jemalloc, None, Some("implementation detail of std, does not provide any public API"), None),
    ...
    (lib, array_error_internals, None, Some("available through Error trait and this method should not be exposed publicly"), None),
    ...
    (lib, c_void_variant, None, Some("should not have to exist"), None),
    (lib, cell_update, Some(50186), None, None),
    (lib, char_error_internals, None, Some("this method should not be available publicly"), None),
    (lib, coerce_unsized, Some(27732), None, None),
    (lib, compiler_builtins_lib, None, Some("Compiler builtins. Will never become stable."), None),
    (lib, concat_idents_macro, Some(29599), None, None),
    (lib, const_int_ops, None, None, None),
    (lib, const_slice_len, None, None, None),
    (lib, const_str_as_bytes, None, None, None),
    (lib, const_str_len, None, None, None),
    (lib, const_vec_new, None, None, None),
    (lib, core_intrinsics, None, Some("intrinsics are unlikely to ever be stabilized, instead they should be used through stabilized interfaces in the rest of the standard library"), None),
    (lib, core_panic, None, Some("internal details of the implementation of the `panic!` and related macros"), None),
    (lib, core_panic_info, Some(44489), Some("newly available in libcore"), None),
    (lib, core_private_bignum, None, Some("internal routines only exposed for testing"), None),
    (lib, core_private_diy_float, None, Some("internal routines only exposed for testing"), None),
    (lib, deadline_api, Some(46316), None, None),
    (lib, decode_utf8, Some(33906), None, None),
    (lib, dec2flt, None, Some("internal routines only exposed for testing"), None),
    (lib, derive_clone_copy, None, Some("deriving hack, should not be public"), None),
    (lib, derive_eq, None, Some("deriving hack, should not be public"), None),
    ...
    (lib, fmt_internals, None, None, None),
    ...
    (lib, future_atomic_orderings, None, None, None),
    ...
    (lib, hashmap_internals, None, None, None),
    (lib, int_error_internals, None, Some("available through Error trait and this method should not be exposed publicly"), None),
    (lib, integer_atomics, Some(32976), None, None),
    (lib, io_error_internals, None, Some("better expressed through extensible enums that this enum cannot be exhaustively matched against"), None),
    ...
    (lib, libstd_sys_internals, None, Some("used by the panic! macro"), None),
    (lib, libstd_thread_internals, None, None, None),
    ...
    (lib, panic_internals, None, Some("internal details of the implementation of the `panic!` and related macros"), None),
    ...
    (lib, process_internals, None, None, None),
    (lib, profiler_runtime_lib, None, Some("internal implementation detail of rustc right now"), None),
    (lib, ptr_internals, None, Some("use into_raw_non_null instead"), None),
    ...
    (lib, raw_vec_internals, None, Some("implemention detail"), None),
    ...
    (lib, rt, None, Some("this public module should not exist and is highly likely to disappear"), None),
    (lib, rustc_private, Some(27812), Some("mainly needed for compiler internals"), None),
    (lib, rustc_stack_internals, None, None, None),
    (lib, rw_exact_all_at, Some(51984), None, None),
    (lib, sanitizer_runtime_lib, None, Some("internal implementation detail of sanitizers"), None),
    (lib, set_stdio, None, Some("this function may disappear completely or be replaced with a more general mechanism"), None),
    (lib, shrink_to, None, Some("new API"), None),
    (lib, slice_align_to, Some(44488), None, None),
    (lib, slice_concat_ext, Some(27747), Some("trait should not have to exist"), None),
    (lib, slice_index_methods, None, None, None),
    (lib, slice_internals, None, Some("exposed from core to be reused in std; use the memchr crate"), None),
    (lib, slice_sort_by_cached_key, Some(34447), None, None),
    (lib, sort_internals, None, Some("internal to sort module"), None),
    (lib, split_ascii_whitespace, Some(48656), None, None),
    (lib, std_internals, None, None, None),
    ...
    (lib, str_internals, None, None, None),
    (lib, test, Some(27812), None, None),
    (lib, termination_trait_lib, Some(43301), None, None),
    (lib, thread_local_internals, None, Some("should not be necessary"), None),
    ...
    (lib, unicode_internals, None, None, None),
    ...
    (lib, update_panic_count, None, None, None),
    ...
    (lib, windows_file_type_ext, None, None, None),
    ...
    // Stable features
    (lib, inclusive_range_methods, None, None, None),
    (lib, from_ref, None, None, None),
    (lib, collections_range, None, None, None),
    (lib, pointer_methods, None, None, None),
    (lib, i128, None, None, None),
    (lib, fs_read_write, None, None, None),
    (lib, peek, None, None, None),
    (lib, inclusive_range, None, None, None),
);
