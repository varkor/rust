...
declare_features! (
    (lib, align_offset, Some(44488), None, None),
    (lib, alloc, Some(27783), None, None),
    (lib, alloc_error_hook, Some(51245), None, None),
    (lib, alloc_internals, Some(0), None, None),
    (lib, alloc_jemalloc, Some(0), Some("implementation detail of std, does not provide any public API"), None),
    (lib, alloc_system, Some(32838), Some("this library is unlikely to be stabilized in its current form or name"), None),
    (lib, allocator_api, Some(32838), None, None),
    (lib, array_error_internals, Some(0), Some("available through Error trait and this method should not be exposed publicly"), None),
    (lib, ascii_ctype, Some(39658), None, None),
    (lib, atomic_min_max, Some(48655), Some("easier and faster min/max than writing manual CAS loop"), None),
    (lib, await_macro, Some(50547), None, None),
    (lib, box_into_raw_non_null, Some(47336), None, None),
    (lib, bufreader_buffer, Some(45323), None, None),
    (lib, bufreader_is_empty, Some(45323), Some("recently added"), None),
    (lib, bufreader_seek_relative, Some(31100), None, None),
    (lib, c_void_variant, Some(0), Some("should not have to exist"), None),
    (lib, cell_update, Some(50186), None, None),
    (lib, char_error_internals, Some(0), Some("this method should not be available publicly"), None),
    (lib, coerce_unsized, Some(27732), None, None),
    (lib, compiler_builtins_lib, Some(0), Some("Compiler builtins. Will never become stable."), None),
    (lib, concat_idents_macro, Some(29599), None, None),
    (lib, const_int_ops, Some(0), None, None),
    (lib, const_slice_len, Some(0), None, None),
    (lib, const_str_as_bytes, Some(0), None, None),
    (lib, const_str_len, Some(0), None, None),
    (lib, const_vec_new, Some(0), None, None),
    (lib, core_intrinsics, Some(0), Some("intrinsics are unlikely to ever be stabilized, instead they should be used through stabilized interfaces in the rest of the standard library"), None),
    (lib, core_panic, Some(0), Some("internal details of the implementation of the `panic!` and related macros"), None),
    (lib, core_panic_info, Some(44489), Some("newly available in libcore"), None),
    (lib, core_private_bignum, Some(0), Some("internal routines only exposed for testing"), None),
    (lib, core_private_diy_float, Some(0), Some("internal routines only exposed for testing"), None),
    (lib, deadline_api, Some(46316), None, None),
    (lib, decode_utf8, Some(33906), None, None),
    (lib, dec2flt, Some(0), Some("internal routines only exposed for testing"), None),
    (lib, derive_clone_copy, Some(0), Some("deriving hack, should not be public"), None),
    (lib, derive_eq, Some(0), Some("deriving hack, should not be public"), None),
    (lib, drain_filter, Some(43244), Some("recently added"), None),
    (lib, duration_as_u128, Some(50202), None, None),
    (lib, error_type_id, Some(27745), Some("unclear whether to commit to this public implementation detail"), None),
    (lib, euclidean_division, Some(49048), None, None),
    (lib, exact_chunks, Some(47115), None, None),
    (lib, exact_size_is_empty, Some(35428), None, None),
    (lib, extra_log_consts, Some(50540), None, None),
    (lib, fixed_size_array, Some(27778), Some("traits and impls are better expressed through generic integer constants"), None),
    (lib, fmt_internals, Some(0), None, None),
    (lib, fn_traits, Some(29625), None, None),
    (lib, fnbox, Some(28796), Some("will be deprecated if and when `Box<FnOnce>` becomes usable"), None),
    (lib, future_atomic_orderings, Some(0), None, None),
    (lib, futures_api, Some(50547), Some("futures in libcore are unstable"), None),
    (lib, gen_future, Some(50547), None, None),
    (lib, generator_trait, Some(43122), None, None),
    (lib, get_type_id, Some(27745), Some("this method will likely be replaced by an associated static"), None),
    (lib, hashmap_internals, Some(0), None, None),
    (lib, int_error_internals, Some(0), Some("available through Error trait and this method should not be exposed publicly"), None),
    (lib, integer_atomics, Some(32976), None, None),
    (lib, io_error_internals, Some(0), Some("better expressed through extensible enums that this enum cannot be exhaustively matched against"), None),
    (lib, io, Some(27802), Some("the semantics of a partial read/write of where errors happen is currently unclear and may change"), None),
    (lib, ip, Some(27709), Some("extra functionality has not been scrutinized to the level that it should be to be stable"), None),
    (lib, ip_constructors, Some(44582), Some("requires greater scrutiny before stabilization"), None),
    (lib, iterator_find_map, Some(49602), Some("unstable new API"), None),
    (lib, libc, Some(27783), Some("use `libc` from crates.io"), None),
    (lib, libstd_io_internals, Some(42788), None, None),
    (lib, libstd_sys_internals, Some(0), Some("used by the panic! macro"), None),
    (lib, libstd_thread_internals, Some(0), None, None),
    (lib, linked_list_extras, Some(27794), Some("this is probably better handled by a cursor type -- we'll see"), None),
    (lib, map_entry_replace, Some(44286), None, None),
    (lib, map_get_key_value, Some(49347), None, None),
    (lib, mpsc_select, Some(27800), None, None),
    (lib, n16, Some(0), None, None),
    (lib, never_type, Some(35121), None, None),
    (lib, no_more_cas, Some(48655), Some("no more CAS loops in user code"), None),
    (lib, no_panic_pow, Some(48320), None, None),
    (lib, offset_to, Some(41079), None, None),
    (lib, once_poison, Some(33577), None, None),
    (lib, option_replace, Some(51998), None, None),
    (lib, option_xor, Some(50512), None, None),
    (lib, panic_abort, Some(32837), None, None),
    (lib, panic_info_message, Some(44489), None, None),
    (lib, panic_internals, Some(0), Some("internal details of the implementation of the `panic!` and related macros"), None),
    (lib, panic_unwind, Some(32837), None, None),
    (lib, pattern, Some(27721), Some("API not fully fleshed out and ready to be stabilized"), None),
    (lib, pin, Some(49150), None, None),
    (lib, proc_macro_diagnostic, Some(38356), None, None),
    (lib, proc_macro_internals, Some(27812), None, None),
    (lib, proc_macro_quote, Some(38356), None, None),
    (lib, proc_macro_raw_ident, Some(38356), None, None),
    (lib, proc_macro_span, Some(38356), None, None),
    (lib, process_exitcode_placeholder, Some(48711), None, None),
    (lib, process_internals, Some(0), None, None),
    (lib, profiler_runtime_lib, Some(0), Some("internal implementation detail of rustc right now"), None),
    (lib, ptr_internals, Some(0), Some("use into_raw_non_null instead"), None),
    (lib, ptr_offset_from, Some(41079), None, None),
    (lib, ptr_wrapping_offset_from, Some(41079), None, None),
    (lib, range_contains, Some(32311), Some("recently added as per RFC"), None),
    (lib, range_is_empty, Some(48111), Some("recently added"), None),
    (lib, raw, Some(27751), None, None),
    (lib, raw_vec_internals, Some(0), Some("implemention detail"), None),
    (lib, read_initializer, Some(42788), None, None),
    (lib, refcell_map_split, Some(51476), None, None),
    (lib, refcell_replace_swap, Some(43570), None, None),
    (lib, repeat_generic_slice, Some(48784), Some("it's on str, why not on slice?"), None),
    (lib, reverse_bits, Some(48763), None, None),
    (lib, rt, Some(0), Some("this public module should not exist and is highly likely to disappear"), None),
    (lib, rustc_private, Some(27812), Some("mainly needed for compiler internals"), None),
    (lib, rustc_stack_internals, Some(0), None, None),
    (lib, rw_exact_all_at, Some(51984), None, None),
    (lib, sanitizer_runtime_lib, Some(0), Some("internal implementation detail of sanitizers"), None),
    (lib, set_stdio, Some(0), Some("this function may disappear completely or be replaced with a more general mechanism"), None),
    (lib, shrink_to, Some(0), Some("new API"), None),
    (lib, slice_align_to, Some(44488), None, None),
    (lib, slice_concat_ext, Some(27747), Some("trait should not have to exist"), None),
    (lib, slice_index_methods, Some(0), None, None),
    (lib, slice_internals, Some(0), Some("exposed from core to be reused in std; use the memchr crate"), None),
    (lib, slice_sort_by_cached_key, Some(34447), None, None),
    (lib, sort_internals, Some(0), Some("internal to sort module"), None),
    (lib, split_ascii_whitespace, Some(48656), None, None),
    (lib, std_internals, Some(0), None, None),
    (lib, stdsimd, Some(48556), None, None),
    (lib, step_trait, Some(42168), Some("likely to be replaced by finer-grained traits"), None),
    (lib, str_escape, Some(27791), Some("return type may change to be an iterator"), None),
    (lib, str_internals, Some(0), None, None),
    (lib, test, Some(27812), None, None),
    (lib, termination_trait_lib, Some(43301), None, None),
    (lib, thread_local_internals, Some(0), Some("should not be necessary"), None),
    (lib, toowned_clone_into, Some(41263), Some("recently added"), None),
    (lib, transpose_result, Some(47338), None, None),
    (lib, trusted_len, Some(37572), None, None),
    (lib, try_from, Some(33417), None, None),
    (lib, try_reserve, Some(48043), Some("new API"), None),
    (lib, try_trait, Some(42327), None, None),
    (lib, unicode, Some(27783), None, None),
    (lib, unicode_internals, Some(0), None, None),
    (lib, unicode_version, Some(49726), None, None),
    (lib, unix_socket_redox, Some(51553), Some("new feature"), None),
    (lib, unsize, Some(27732), None, None),
    (lib, update_panic_count, Some(0), None, None),
    (lib, vec_remove_item, Some(40062), Some("recently added"), None),
    (lib, vec_resize_default, Some(41758), None, None),
    (lib, vec_resize_with, Some(41758), None, None),
    (lib, wait_timeout_until, Some(47960), None, None),
    (lib, wait_until, Some(47960), None, None),
    (lib, windows_file_type_ext, Some(0), None, None),
    ...
    (lib, collections_range, Some(0), None, None),
    (lib, pointer_methods, Some(0), None, None),
    (lib, i128, Some(0), None, None),
    (lib, fs_read_write, Some(0), None, None),
    (lib, peek, Some(0), None, None),
    (lib, inclusive_range, Some(0), None, None),
);
