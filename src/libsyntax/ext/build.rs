...
pub trait AstBuilder {
    ...
    fn const_(&self, span: Span, expr: ast::ExprKind) -> P<ast::Expr>;
    fn const_ident(&self, span: Span, idents: ast::Ident) -> P<ast::Expr>;
...
impl<'a> AstBuilder for ExtCtxt<'a> {
    ...
    fn const_ident(&self, span: Span, ident: ast::Ident) -> P<ast::Expr> {
        self.const_(span, ast::ExprKind::Path(None, self.path_ident(span, ident)))
    }
