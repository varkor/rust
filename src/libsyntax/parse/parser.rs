...
use ast::{Label, Lifetime, Lit, LitKind, UintTy};
use ast::Local;
...
impl<'a> Parser<'a> {
    ...
    pub fn parse_ty_bare_fn(&mut self, generic_params: Vec<GenericParamAST>)
                            -> PResult<'a, TyKind> {
        /*
    ...
    pub fn parse_generic_params(&mut self) -> PResult<'a, Vec<ast::GenericParamAST>> {
