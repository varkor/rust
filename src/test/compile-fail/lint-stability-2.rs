...
mod cross_crate {
    ...
    fn test() {
        ...
        //~^ ERROR use of unstable library feature 'test_unstable_feature': text
...
mod this_crate {
    ...
    #[unstable(feature = "test_unstable_feature", issue = "0")]
    pub fn unstable() {}
    #[unstable(feature = "test_unstable_feature", reason = "text", issue = "0")]
    ...
    pub struct DeprecatedStruct {
        #[stable(feature = "test_stable_feature", since = "1.0.0")] i: isize
    }
    #[unstable(feature = "test_unstable_feature", issue = "0")]
