...
<<<<<<< HEAD:src/librustc_typeck/constrained_generic_params.rs
...
=======
    fn visit_const(&mut self, c: &'tcx ty::LazyConst<'tcx>) -> bool {
        if let ty::LazyConst::Evaluated(ty::Const {
            ...
            self.parameters.push(Parameter::from(*data));
>>>>>>> Const generics:src/librustc_typeck/constrained_params.rs
        }
        false
    }
}
...
=======
pub fn identify_constrained_params<'tcx>(tcx: TyCtxt<'_, 'tcx, 'tcx>,
>>>>>>> Const generics:src/librustc_typeck/constrained_params.rs
